...
class NewsRepository {
  ...
  Future addNews(
    ...
    try {
      ...
      Response response = await _dio.post(
        'https://latihan-flutter.000webhostapp.com/addnews.php',
        data: formData,
      );
  ...
  Future getNewsList(keyword) async {
    try {
      ...
      var response = await _dio.get(
        'https://latihan-flutter.000webhostapp.com/listnews.php',
  ...
  Future selectNews(String id) async {
    ...
    final response = await _dio.post(
      'https://latihan-flutter.000webhostapp.com/selectdata.php',
      data: formData,
    );
  ...
  Future editNews(
    ...
    try {
      ...
      Response response = await _dio.post(
        'https://latihan-flutter.000webhostapp.com/editnews.php',
        data: formData,
      );
  ...
  Future deleteNews(String id) async {
    try {
      ...
      final response = await _dio.post(
        'https://latihan-flutter.000webhostapp.com/deletenews.php',
        data: formData,
      );
